...
// MQTT Client configuration - dùng chung với AirSENSE
// Ưu tiên: ENOSE_MQTT_BROKER_URL > APP_MQTT > mqtt://localhost:1883
const mqttBrokerUrl = process.env.ENOSE_MQTT_BROKER_URL || process.env.APP_MQTT || "mqtt://localhost:1883";
const mqttConfig = require('../config/default.json').mqtt[0] || {};
const mqttClient = mqtt.connect(mqttBrokerUrl, {
  ...mqttConfig,
  clientId: mqttConfig.clientId || 'enose_' + Math.random().toString(16).substr(2, 8)
});
