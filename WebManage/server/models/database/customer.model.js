...
class Customer extends CommonModel {
  ...
  getSQLReport(currentUser) {
    ...
    return (
      " SELECT customer.customer_id,customer.username,customer.email,customer.phone_number,customer.avatar,customer.fullname,customer.contact, customer.address," +
