          ...
          <Row>
            <Col span={10}>
              <Form.Item label="Nhập mật khẩu mới">
                <Input name="new_pass_word" placeholder="Enter password" />
              </Form.Item>
            </Col>
          </Row>
          <Row>
            <Col span={10}>
              <Form.Item label="Nhập lại mật khẩu mới">
                <Input name="confirm_new_pass_word" id="display" placeholder="Enter password" value ={newPassword} onChange={e=>handleNewPassord(e)}/>
              </Form.Item>
            </Col>
          </Row>
