...
import { ColorButton } from '../../custom/ButtonCustom';
...
class TableDataView extends Component {
  ...
  callBackEdit = (type) => {
    ...
    if (ActionControl.ACTION_UPDATE == type)
      this.setState({ dialogueEdit: true });
    if (ActionControl.ACTION_DELETE == type)
      this.setState({ dialogueDelete: true });
  };
